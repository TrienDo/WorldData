function makeLineChart(dataset, xName, yObjs, axisLables, width, height) {
    var chartObj = {};
    ...
    chartObj.render = function () {
        ...
        chartObj.svg.append("g").attr("class", "y axis").call(chartObj.yAxis).append("text").attr("class", "label").attr("transform", "rotate(-90)").attr("y", -42).attr("x", -chartObj.height / 2).attr("dy", ".01em").style("text-anchor", "middle").text(chartObj.yAxisLable);
